$(document).ready(function () {
    ...
    let informationDisclosure = function (i) {
        $(informationDisclosureBtn[i]).click(function () {
            if (!clickinformationDisclosureItem[i].select) {
                ...
                clickinformationDisclosureItem[i].select = true;
            } else if (clickinformationDisclosureItem[i].select) {
                ...
                clickinformationDisclosureItem[i].select = false;
            }
